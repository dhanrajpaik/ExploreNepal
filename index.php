...
// // Greedy algorithm to recommend travel packages
// function recommendPackages($packages, $budget, $days, $interest) {
//     // Sort packages by relevance (interest match first, then by price)
//     usort($packages, function ($a, $b) use ($interest) {
...
//     // Greedy selection of packages
//     foreach ($packages as $package) {
//         if ($total_cost + $package['price'] <= $budget && $total_days + $package['duration'] <= $days) {
...
// $recommended_packages = recommendPackages($packages, $user_budget, $user_days, $user_interest);
?>
?>
<!DOCTYPE html>
<html lang="en">
